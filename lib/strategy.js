...
function WechatStrategy(options, verify) {
    options = options || {};
    options.authorizeUrl = options.authorizeUrl || 'https://open.weixin.qq.com/connect/oauth2/authorize';
    options.accessTokenUrl = options.accessTokenUrl || 'https://api.weixin.qq.com/sns/oauth2/access_token';
